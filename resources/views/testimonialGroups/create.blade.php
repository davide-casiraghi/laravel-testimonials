                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::input', [
                            ...
                            'tooltip' => 'Exadecimal value for the group title color.',
                            'placeholder' => '#HEX', 
                            'value' => old('testimonial_title_color'),
                            'required' => false,
                        ])
                    </div>
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::input', [
                            ...
                            'placeholder' => '', 
                            'value' => old('testimonial_title_font_size'),
                            'required' => false,
                        ])
                    </div>
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::input', [
                            ...
                            'placeholder' => '', 
                            'value' => old('testimonials_flex'),
                            'required' => true,
                            'tooltip' => 'The flex property applied to all testimonials. Can be overrided by setting the flex property of the single child. Eg. 1 0 320px (grow shrink basis) or 0 1 auto',
                        ])
                    </div>
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::input', [
                            ...
                            'placeholder' => '', 
                            'value' => old('testimonials_padding'),
                            'required' => true,
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::select', [
                              ...
                              'liveSearch' => 'false',
                              'mobileNativeMenu' => true,
                              'selected' => old('testimonials_box_sizing'),
                              'required' => false,
                              'tooltip' => '- row-reverse: it will show the element in horizontal way starting from right. - testimonial: switch the main axis from horizontal to vertical showing elements starting from top. - testimonial-reverse: switch the main axis from horizontal to vertical showing elements starting from bottom.',
                        ])
                    </div>
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::checkbox', [
                              ...
                              'value' => old('testimonials_round_images'),
                              'required' => false,
                        ])
                    </div>
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::input', [
                            ...
                            'placeholder' => '', 
                            'value' => old('testimonials_images_width'),
                            'required' => true,
                            'tooltip' => 'eg. 30px',
                        ])
                    </div>
                    ...
                    <div class="col-12">
                        @include('laravel-form-partials::checkbox', [
                              ...
                              'value' => old('testimonials_images_hide_mobile'),
                              'required' => false,
                        ])
                    </div>
