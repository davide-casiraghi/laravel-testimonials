...
use DavideCasiraghi\LaravelTestimonials\LaravelTestimonialsServiceProvider;
...
abstract class TestCase extends BaseTestCase
{
    ...
    {
        return [
            LaravelTestimonialsServiceProvider::class,
    ...
    {
        return [
            'LaravelTestimonials' => LaravelTestimonials::class, // facade called PhpResponsiveQuote and the name of the facade class
